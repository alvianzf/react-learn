    ...
    render() {
        return (
            <Container className="cards">
                ...
                <Row>
                    <CardDeck>
                        <Cards image={logo5} title="gofood" description="The largest food delievery in Indonesia and Southeast Asia" />
                        <Cards image={logo6} description="Enjoy a variety of favorite cuisine consisting foods, beverage. traditional snacks, trending snacks & exciting events at the GoFood Culinary Festival." />
                        <Cards image={logo7} title="gomed" description="" />
                    </CardDeck>
                </Row>
